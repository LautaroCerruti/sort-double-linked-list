...
int main(int argc, char *argv[]) {
  ...
  glist_test_sort_algorithm("selection_sort_largo_nombre", lista, glist_selection_sort, persona_compara_largo_nombre, persona_imprimir_archivo);
  glist_test_sort_algorithm("insertion_sort_edad", lista, glist_insertion_sort, persona_compara_edad, persona_imprimir_archivo);
  glist_test_sort_algorithm("insertion_sort_largo_nombre", lista, glist_insertion_sort, persona_compara_largo_nombre, persona_imprimir_archivo);
  glist_test_sort_algorithm("merge_sort_edad", lista, glist_merge_sort, persona_compara_edad, persona_imprimir_archivo);
  glist_test_sort_algorithm("merge_sort_largo_nombre", lista, glist_merge_sort, persona_compara_largo_nombre, persona_imprimir_archivo);
